...
WebUI.verifyElementVisible(findTestObject('Transaction/Inventory-page/product_name', [('product_name') : product_name]))

'product id untuk mencari button add to cart yang bersangkutan dengan product yang ingin dipilih'
WebUI.click(findTestObject('Transaction/Inventory-page/button_Add to cart', [('product_id') : product_id]))
